# Schema Summary: OpenOrganelle

**Source markdown:** `/projects/weilab/shenb/mitoFoundation2/1web_scraper_01/outputs/OpenOrganelle.md`

**Database file:** `/projects/weilab/shenb/mitoFoundation2/2database_builder/outputs/databases/OpenOrganelle.db`
...
- `dataset_layers`: **887**
- `dataset_sources`: **86**
- `datasets` with good (non-prediction) mito segmentation labels: **12**
...
|--------|------:|
| Datasets (rows) | **86** |
| Ready for **labeled** download (EM + mito seg path) | **12** |
| Ready for **EM-only** / unlabeled (has EM path) | **17** |
| Rows missing EM or seg (not fully paired) | **69** |
